  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4">
      <div className="max-w-md w-full text-center">
        {/* 404 Illustration */}
        <div className="mb-8">
          <svg className="w-32 h-32 text-blue-600 mx-auto mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              to="/book-ride"
              className="flex-1 border border-blue-600 text-blue-600 py-2 px-4 rounded-lg font-medium hover:bg-blue-50 transition-colors duration-200 text-center"
            >
              Book a Ride
            </Link>
            <Link
              to="/rent-car"
              className="flex-1 border border-green-600 text-green-600 py-2 px-4 rounded-lg font-medium hover:bg-green-50 transition-colors duration-200 text-center"
            >
              Rent a Car
            </Link>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <Link to="/my-rides" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
              My Rides
            </Link>
            <Link to="/my-rentals" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
              My Rentals
            </Link>
            <Link to="/login" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
              Sign In
            </Link>
            <Link to="/register" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
              Sign Up
            </Link>
          </div>
        </div>
