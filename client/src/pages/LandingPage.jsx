...
const LandingPage = () => {
  return (
    <div className="bg-gray-900">
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-600">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Ride Booking</h3>
            ...
            <div className="bg-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-600">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Car Rental</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Always On Time</h3>
              <p className="text-gray-300">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-600 bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      {/* CTA Section */}
      <section className="bg-gray-800 text-white py-20 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/register"
              className="border-2 border-gray-400 text-gray-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-700 hover:border-gray-300 transition-colors duration-200"
            >
              Create Account
            </Link>
          </div>
