        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/book-ride" className="text-gray-400 hover:text-white transition-colors duration-200">Book a Ride</a></li>
              <li><a href="/rent-car" className="text-gray-400 hover:text-white transition-colors duration-200">Rent a Car</a></li>
              <li><a href="/my-rides" className="text-gray-400 hover:text-white transition-colors duration-200">My Rides</a></li>
              <li><a href="/my-rentals" className="text-gray-400 hover:text-white transition-colors duration-200">My Rentals</a></li>
            </ul>
          </div>
